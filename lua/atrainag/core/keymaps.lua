...
-- Obsidian
vim.keymap.set("n", "<leader>on", ":ObsidianNew<CR>", { noremap = true, silent = true, desc = "Obsidian: New note" })
vim.keymap.set(
  "n",
  "<leader>ot",
  ":ObsidianNewFromTemplate<CR>",
  { noremap = true, silent = true, desc = "Obsidian: New note from template" }
)
vim.keymap.set(
  "n",
  "<leader>ov",
  ":ObsidianFollowLink vsplit<CR>",
  { silent = true, desc = "Obsidian: Follow link (vsplit)" }
)
...
vim.keymap.set("v", "<leader>oln", ":ObsidianLinkNew<CR>", {
  silent = true,
  desc = "Obsidian: Create note & link selection",
})
vim.keymap.set(
  "n",
  "<leader>oh",
  ":ObsidianFollowLink hsplit<CR>",
  { silent = true, desc = "Obsidian: Follow link (hsplit)" }
)
...
vim.keymap.set("n", "<leader>odd", ":ObsidianToday<CR>", {
  silent = true,
  desc = "Obsidian: Open or Create Today's Note",
})
vim.keymap.set("n", "<leader>odt", ":ObsidianTomorrow<CR>", {
  silent = true,
  desc = "Obsidian: Open or Create Tomorrow's Note",
})
vim.keymap.set("n", "<leader>ody", ":ObsidianYesterday<CR>", {
  silent = true,
  desc = "Obsidian: Open or Create Yesterday's Note",
})
vim.keymap.set("n", "<leader>odl", ":ObsidianDailies<CR>", {
  silent = true,
  desc = "Obsidian: Open Dailies Note List",
})
vim.keymap.set("n", "<leader>oR", ":ObsidianRename<CR>", {
  silent = true,
  desc = "Obsidian: Rename note",
})
vim.keymap.set("n", "<leader>or", ":ObsidianRename --dry-run<CR>", {
  silent = true,
  desc = "Obsidian: Rename note (dry run)",
})
